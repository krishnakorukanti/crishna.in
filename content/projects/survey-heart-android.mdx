...
<div style={{ display: 'flex', justifyContent: 'space-between' ,overflowX: "auto",whiteSpace: 'nowrap'}}>
    <img src="/sh-android/A-Sh-2.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-3.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-4.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-5.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-6.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-7.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-8.webp" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
