...
<div style={{ display: 'flex', justifyContent: 'space-between' ,overflowX: "auto",whiteSpace: 'nowrap'}}>
    <img src="../surveyheartandroid/a-sh2.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="../surveyheartandroid/a-sh3.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="../surveyheartandroid/a-sh4.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="../surveyheartandroid/a-sh5.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="../surveyheartandroid/a-sh6.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="../surveyheartandroid/a-sh7.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="../surveyheartandroid/a-sh8.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
