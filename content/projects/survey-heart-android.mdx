...
<div style={{ display: 'flex', justifyContent: 'space-between' ,overflowX: "auto",whiteSpace: 'nowrap'}}>
    <img src="/sh-android/A-Sh-2.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-3.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-4.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-5.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-6.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-7.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
    <img src="/sh-android/A-Sh-8.png" alt="SurveyHeart Android App Screenshot 1" style={{ width: '48%', height: 'auto' }} />
